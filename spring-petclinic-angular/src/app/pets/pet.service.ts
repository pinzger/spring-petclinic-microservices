...
export class PetService {
  ...
  private entityUrl = environment.REST_API_URL + 'customer/owners';
  ...
  getPets(ownerId: string): Observable<Pet[]> {
    return this.http.get<Pet[]>(this.entityUrl + "/" + ownerId)
      .pipe(
  ...
  getPetById(petId: string): Observable<Pet> {
    return this.http.get<Pet>(this.entityUrl + '/*/pets/' + petId)
      .pipe(
  ...
  addPet(pet: Pet): Observable<Pet> {
    return this.http.post<Pet>(this.entityUrl + "/" + pet.owner.id + "/pets", pet)
      .pipe(
  ...
  updatePet(petId: string, pet: Pet): Observable<Pet> {
    return this.http.put<Pet>(this.entityUrl + '/*/pets/' + petId, pet)
      .pipe(
  ...
  deletePet(petId: string): Observable<number> {
    return this.http.delete<number>(this.entityUrl + '/*/pets/' + petId)
      .pipe(
